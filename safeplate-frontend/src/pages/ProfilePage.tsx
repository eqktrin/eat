...
const ProfilePage: React.FC = () => {
    ...
    const [user, setUser] = useState<UserProfile>({ email: "", allergens: [] });
    ...
    const handleAddAllergen = async (): Promise<void> => {
    ...
    const handleRemoveAllergen = async (allergen: string): Promise<void> => {
