...
const AIPage: React.FC = () => {
    ...
    const fetchUserAllergens = async (): Promise<void> => {
        try {
    ...
    const handleSearch = async (): Promise<void> => {
        ...
        try {
            ...
            const res = await api.post<AIResponse>("ai/query", {
                query: query,
                user_id: userId
            });
    ...
    const hasDangerousAllergens = (dishAllergens: string[]): boolean => {
        return dishAllergens.some(allergen => userAllergens.includes(allergen));
    };

    const handleFavorite = async (dish: Dish): Promise<void> => {
        try {
    ...
    const handleOrder = async (dish: Dish): Promise<void> => {
